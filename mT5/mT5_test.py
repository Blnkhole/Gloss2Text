...
model_path = "/content/drive/MyDrive/c3576"
...
def evaluate_on_test_set(test_dataset, batch_size = 64):
    ...
    for i in tqdm(range(0, len(test_dataset), batch_size)):
        ...
        inputs_with_prefix = ["translate gloss to vietnamese: " + str(g) for g in batch["gloss"]]

        inputs = tokenizer(inputs_with_prefix, return_tensors = "pt",  padding = True, truncation = True, max_length = 128)
...
df_results.to_csv("/content/drive/MyDrive/Gloss2Text/test_prediction_mT5_base_UPPERCASE.tsv", sep = "\t", index = False)
print("Complete!")