...
raw_train_dataset = Dataset.from_pandas(pd.read_csv("/content/drive/MyDrive/Gloss2Text/train_upper.tsv", sep = "\t", names = ["gloss", "text"]))
raw_val_dataset = Dataset.from_pandas(pd.read_csv("/content/drive/MyDrive/Gloss2Text/dev_upper.tsv", sep = "\t", names = ["gloss", "text"]))
...
trainer.save_model("/content/drive/MyDrive/Gloss2Text/best_model_upper")
tokenizer.save_pretrained("/content/drive/MyDrive/Gloss2Text/best_model_upper")
...
print(generate("CHÚ TÔI CHIẾC XE ĐẠP NÀY TẶNG TÔI NHƯ MÓN QUÀ SINH NHẬT NHÌN KÌA !"))